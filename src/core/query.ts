...
import { HOST_TAG, isVisible, renderedText, sectionOf, snippet, stableSelector } from "./describe";
...
const isOurs = (el: Element) => el.localName === HOST_TAG;
...
const labelOf = (el: Element) =>
  [renderedText(el), el.getAttribute("aria-label"), el.getAttribute("alt"), el.getAttribute("title"), el.getAttribute("placeholder"), (el as HTMLInputElement).value]
