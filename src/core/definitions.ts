// Tool definitions for every Reword command. This module has no DOM or
...
export const COMMAND_DEFINITIONS = [
  ...
  { name: "clear_all", description: "Revert every change in the session (undoable).", parameters: noParams },
  ...
  {
    name: "select_parent",
    description: "Select the parent of the selected element (or of elementId), e.g. to widen a selection from a <span> to its <button>.",
    parameters: {
      type: "object",
      properties: { elementId: { ...elementId, description: "Element whose parent to select. Defaults to the current selection." } },
      additionalProperties: false,
    },
  },
  {
    name: "set_enabled",
    description: "Turn the Reword editing UI on or off for this tab. Applied changes stay on the page either way.",
    parameters: {
      type: "object",
